				...
				<div class="row">
					...
					<div class="col mb-0 test">
						...
						<div class="d-flex align-items-center justify-content-between">
								...
								<input type="button"  class="btn btn-primary" value="시연용" onclick="dummypro()" style="margin-left: -138px;">
...
function dummypro(){
    document.getElementById('proNm').value='전시회참가신청을 위한 프로젝트 생성건'; 
    document.getElementById('proBdate').value='2024-01-25';
    document.getElementById('proEdate').value='2024-03-25';  
}
