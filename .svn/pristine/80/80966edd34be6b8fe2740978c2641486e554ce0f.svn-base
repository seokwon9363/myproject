...
<div class="card-body" style="background-color:white; overflow:scroll; height:40%;">
	<div class="table-responsive text-nowrap" style="text-align:center;">
		...
		<div style="display:flex; align-items: center;"><div style="background-color:#6FADCF; width: 15px; height:15px; margin-right: 5px;"></div> : 지각<div style="background-color:#6DFCF0; width: 15px; height:15px; margin-left:10px; margin-right: 5px;"></div> : 반차  <div style="background-color:yellow; width: 15px; height:15px; margin-left:10px; margin-right: 5px;"></div> : 휴가</div>
