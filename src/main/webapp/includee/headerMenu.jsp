    ...
    <div class="collapse navbar-collapse" id="navbar-ex-7">
      ...
      <c:if test="${realUser.username   ne 'admin'}">
        <li class="nav-item">
        	...
        	<img src="${sessionScope.empDetail.empProfileImg }" alt="" class="rounded-circle mb-1 mx-sm-2" 
				style="height: 22px;">
        	${sessionScope.empDetail.empName } 님</a>
        </li> 
      	<li class="nav-item">
									...
									<div class="card mb-4" id="leftBbody">
										...
										<div class="user-profile-header d-flex flex-column flex-sm-row text-sm-start text-center mb-4">
											<div class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto pro_img" id="profileArea">
												<img id="profileMypage" src="" alt="사용자 이미지" class="d-block h-auto ms-0 ms-sm-4 rounded user-profile-img" _mstalt="136097" _msthash="273">
											</div>
												...
												<div class="card-body">
													<small class="text-muted text-uppercase" _msttexthash="9296404" _msthash="306">서명</small>
														<div class="sign_img fixed_img">
															<img id="signMypage" src="" alt="사용자 이미지" class="d-block h-auto ms-0 ms-sm-4 rounded user-profile-img" _mstalt="136097" _msthash="273">
														</div>
												</div>
											</div>
										</div>
