...
function fCalAddTest(){
	console.log("1")
	
	let schTitle = document.getElementById("schTitle");
	let schContent = document.getElementById("schContent");
	
	let schStart = document.getElementById("schStart");
	let schEnd = document.getElementById("schEnd");
	
	schStart.value='2023-12-14T08:00';
	schEnd.value='2023-12-15T17:03';
	
	schTitle.value = '(프로젝트) 1박2일 워크숍';
	schContent.innerHTML = '대천 워크숍';
}        