	...
	let html = `
		<div class="container mt-5">
		    ...
		    <form id="boardForm">
		        ...
		        </div> <button type="button" class="btn btn-primary" onclick="submitBoardTest()" style="float:right;">자동완성</button><br /> 
...
function submitBoardTest(){
	...
	postTitle.value = "자유게시판";
	editor.innerHTML = "자유게시판 생성하겠습니다.";
}